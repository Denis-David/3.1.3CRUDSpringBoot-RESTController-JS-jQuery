let viewUsersUrl = 'http://localhost:8088/admin/userList';
let authUserUrl = 'http://localhost:8088/user/authUser';
let newUserUrl = 'http://localhost:8088/admin/newUser';
let deleteUserUrl = 'http://localhost:8088/admin/deleteUser/';
let getUserByIdUrl = 'http://localhost:8088/admin/user/';
let updateUserUrl = 'http://localhost:8088/admin/updateUser';
